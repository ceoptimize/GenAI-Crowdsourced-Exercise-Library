...
CREATE TABLE "Exercises" (
    ...
    "ExerciseDifficulty" int   NOT NULL,
...
ALTER TABLE "ExerciseRelation" ADD CONSTRAINT "fk_ExerciseRelation_RelatinID" FOREIGN KEY("ExerciseID")
REFERENCES "Exercises" ("ExerciseID");
