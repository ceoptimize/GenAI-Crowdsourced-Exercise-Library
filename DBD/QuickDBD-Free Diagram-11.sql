...
-- Link to schema: https://app.quickdatabasediagrams.com/#/d/jZbbc3
-- NOTE! If you have used non-SQL datatypes in your design, you will have to change these here.


CREATE TABLE "Exercises" (
    "ExerciseID" SERIAL   NOT NULL,
    "ExerciseDifficulty" float8   NOT NULL,
...
CREATE TABLE "ExerciseName" (
    "ExerciseNameID" SERIAL   NOT NULL,
    "ExerciseID" int   NOT NULL,
    "ExerciseName" VARCHAR(50)   NOT NULL,
    "IsPrimary" boolean   NOT NULL,
    "IsPrimaryVotes" int   NOT NULL,
    CONSTRAINT "pk_ExerciseName" PRIMARY KEY (
        "ExerciseNameID"
     )
);
...
CREATE TABLE "ExerciseRelation" (
    "ExerciseRelationID" int   NOT NULL,
    "ExerciseID" int   NOT NULL,
...
ALTER TABLE "ExerciseName" ADD CONSTRAINT "fk_ExerciseName_ExerciseID" FOREIGN KEY("ExerciseID")
...
CREATE INDEX "idx_ExerciseName_ExerciseName"
ON "ExerciseName" ("ExerciseName");
