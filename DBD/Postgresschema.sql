...
CREATE TABLE "JointJointMovement" (
    "JointJointMovementID" SERIAL   NOT NULL,
    "JointID" int   NOT NULL,
    "JointMovementID" int   NOT NULL,
    "CreatorGenerated" boolean   NOT NULL,
    "GPTVotes" int   NOT NULL,
    "GPTConfidence" float8   NOT NULL,
    "GPTLog" JSONB   NOT NULL,
    CONSTRAINT "pk_JointJointMovement" PRIMARY KEY (
...
ALTER TABLE "JointJointMovement" ADD CONSTRAINT "fk_JointJointMovement_JointID" FOREIGN KEY("JointID")
REFERENCES "Joint" ("JointID");

ALTER TABLE "JointJointMovement" ADD CONSTRAINT "fk_JointJointMovement_JointMovementID" FOREIGN KEY("JointMovementID")
REFERENCES "JointMovement" ("JointMovementID");
